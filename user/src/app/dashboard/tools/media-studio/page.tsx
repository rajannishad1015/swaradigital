                ...
                <div className="relative flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
                    <div className="space-y-3">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-4xl font-bold tracking-tight text-white">Media Studio</h1>
                        </div>
                        <p className="text-zinc-400 text-lg font-medium">Professional grade client-side audio and video toolkit.</p>
                    </div>
